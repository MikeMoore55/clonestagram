...
export default function EditAccountForm({ account }) {
  ...
  // to get specific data from arrays
  function extractData(arr, prop) {
      const extractedValue = arr.map(item => item[prop]);
      return extractedValue;
  };

  // getting all the original data (to be displayed in the inputs)
    ...
    <div className={styles.container}>
      <form onSubmit={(e) => {updateAccount(e)}} className={styles.editForm}>
        ...
        <div>
          ...
          {/* need to use the line breaks (or else the layout looks horrible [even with margin and padding added]) */}
          <br /> 
          <br />
          <br/>
