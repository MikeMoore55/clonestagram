...
// post item within the post list for home page


// --- need to make so it only displays posts from users following [when following and followers function complete] ---
...
export default function PostItem({ posted }) { 
    ...
    // add comments, get comments, display comments [working on]

    return (
        <div className={styles.container}>

            {/* to take to account page of the "posts" user */}
            ...
            <div className={styles.postInteraction}>
                ...
                <span className={styles.comments}>Comments</span> {/* coming soon */}
            </div>
